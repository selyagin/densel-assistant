const CACHE = 'densel-assistant-v13';
const ASSETS = ['./','./index.html','./style.css','./app.js','./manifest.json','./patch-61.js','./patch-72.js','./patch-91.js','./patch-92.js'];
...
self.addEventListener('fetch', e => {
  ...
  e.respondWith(fetch(e.request,{cache:'no-store'}).then(async resp => {
    if (isDocument && resp.ok) {
      ...
      const scripts = '<script src="./patch-61.js"></script><script src="./patch-72.js"></script><script src="./patch-91.js"></script><script src="./patch-92.js"></script>';
