const CACHE = 'densel-assistant-v10';
const ASSETS = ['./','./index.html','./style.css','./app.js','./manifest.json','./patch-61.js','./patch-72.js','./patch-81.js','./patch-82.js','./patch-83.js','./patch-84.js'];
...
self.addEventListener('fetch', e => {
  ...
  e.respondWith(fetch(e.request,{cache:'no-store'}).then(async resp => {
    if (isDocument && resp.ok) {
      ...
      const scripts = '<script src="./patch-61.js"></script><script src="./patch-72.js"></script><script src="./patch-81.js"></script><script src="./patch-82.js"></script><script src="./patch-83.js"></script><script src="./patch-84.js"></script>';
